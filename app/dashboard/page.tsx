          ...
          <div className="flex-col flex-1">
            ...
            <div>
              <div className="min-w-full h-16 p-4 bg-white border-b border-black border-opacity-10 justify-between items-center inline-flex">
                ...
                <button className="focus:outline-none text-white bg-orange-500 hover:bg-orange-800 font-medium rounded-lg text-xs py-2 dark:bg-orange-500 dark:hover:bg-orange-700 px-3 flex justify-between items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="pr-1" viewBox="0 0 24 24">
            ...
            <div className="flex justify-between flex-1 px-4 py-4 items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="inline-flex rounded-md shadow-sm">
                  <button aria-current="page" className="px-3 py-2 text-xs font-medium text-stone-500 hover:text-stone-500 bg-white border border-black border-opacity-10 rounded-s-lg hover:bg-gray-100 flex justify-between items-center">
                    <div className="pr-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
                  ...
                  <button className="px-3 py-2 text-xs font-medium text-stone-500 hover:text-stone-500 bg-white border border-black border-opacity-10 rounded-e-lg hover:bg-gray-100 flex justify-between items-center">
                    <div className="pr-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
            ...
            <div className="px-4">
              <div className="px-3 py-2 border border-black border-opacity-10 rounded-lg">
                <DataTable value={products} showGridlines={true} tableStyle={{ minWidth: '100%', width: '100%', }}>
                  {columns.map((col, i) => (
